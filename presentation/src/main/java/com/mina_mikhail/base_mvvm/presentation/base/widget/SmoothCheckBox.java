package com.mina_mikhail.base_mvvm.presentation.base.widget;
...
public class SmoothCheckBox
  ...
  private void init(AttributeSet attrs) {
    ...
    int tickColor =
        ta.getColor(R.styleable.SmoothCheckBox_color_tick, COLOR_TICK);
    mAnimDuration =
        ta.getInt(R.styleable.SmoothCheckBox_duration, DEF_ANIM_DURATION);
    mFloorColor = ta.getColor(R.styleable.SmoothCheckBox_color_unchecked_stroke,
        COLOR_FLOOR_UNCHECKED);
    mCheckedColor =
        ta.getColor(R.styleable.SmoothCheckBox_color_checked, COLOR_CHECKED);
    mUnCheckedColor = ta.getColor(R.styleable.SmoothCheckBox_color_unchecked,
        COLOR_UNCHECKED);
    mStrokeWidth =
        ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, dp2px(getContext(), 0));
    ta.recycle();
  ...
  private int getColorFloorUnchecked() {
    return mFloorUnCheckedColor;
  }

  private void setColorFloorUnchecked(int color) {
